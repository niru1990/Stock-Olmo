...
<link rel="stylesheet" href="path/to/font-awesome/css/font-awesome.min.css">
    ...
    <ul class="menu">
      ...
      <li>
        ...
        >
            <i class="fa fa-home menu__icon" ></i>
            Home
        </a>
      </li>
      ...
      <li>
        <a
        href="#"
        @click.prevent="updateMenu('ordenes')"
        :class="highlightSection('ordenes')"
        >
          <i class="fa fa-tag menu__icon" aria-hidden="true"></i>
          Ordenes
          <i class="fa fa-chevron-right menu__arrow-icon" aria-hidden="true"></i>
      ...
      <li>
        <a
        href="#"
        @click.prevent="updateMenu('clientes')"
        :class="highlightSection('clientes')"
        >
          <i class="fa fa-tag menu__icon" aria-hidden="true"></i>
          Clientes
          <i class="fa fa-chevron-right menu__arrow-icon" aria-hidden="true"></i>
      ...
      <li>
        <a
        href="#"
        @click.prevent="updateMenu('proveedores')"
        :class="highlightSection('proveedores')"
        >
          <i class="fa fa-tag menu__icon" aria-hidden="true"></i>
          Proveedores
          <i class="fa fa-chevron-right menu__arrow-icon" aria-hidden="true"></i>
      ...
      <li>
        <a
        href="#"
        @click.prevent="updateMenu('reportes')"
        :class="highlightSection('reportes')"
        >
          <i class="fa fa-tag menu__icon" aria-hidden="true"></i>
          Reportes
          <i class="fa fa-chevron-right menu__arrow-icon" aria-hidden="true"></i>
